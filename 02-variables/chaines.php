                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdown04">
                            ...
                            <a class="dropdown-item active" href="../02-variables/chaines.php">Chaînes</a>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdown04">
                            <a class="dropdown-item" href="#I.">I. Les chaînes de caractères</a>
                            <a class="dropdown-item" href="#II.">II. Concaténer les caractères</a>
                        </div>
                    </li>
                </ul>
            </div>
